...
extern fractional f1_to_f2_buffer_i_a[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F2_INPUT_SIZE];
extern fractional f1_to_f2_buffer_q_a[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F2_INPUT_SIZE];
extern fractional f2_to_f3_buffer_i_a[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F3_INPUT_SIZE];
extern fractional f2_to_f3_buffer_q_a[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F3_INPUT_SIZE];
extern fractional f1_to_f2_buffer_i_b[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F2_INPUT_SIZE];
extern fractional f1_to_f2_buffer_q_b[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F2_INPUT_SIZE];
extern fractional f2_to_f3_buffer_i_b[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F3_INPUT_SIZE];
extern fractional f2_to_f3_buffer_q_b[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F3_INPUT_SIZE];
extern fractional f3_to_f4_buffer_i_a[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F4_INPUT_SIZE];
extern fractional f3_to_f4_buffer_q_a[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F4_INPUT_SIZE];
extern fractional f4_to_fx_buffer_i_a[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_FX_INPUT_SIZE];
extern fractional f4_to_fx_buffer_q_a[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_FX_INPUT_SIZE];
extern fractional f3_to_f4_buffer_i_b[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F4_INPUT_SIZE];
extern fractional f3_to_f4_buffer_q_b[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F4_INPUT_SIZE];
extern fractional f4_to_fx_buffer_i_b[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_FX_INPUT_SIZE];
extern fractional f4_to_fx_buffer_q_b[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_FX_INPUT_SIZE];
...
void adc_rx_callback_25khz(void){
    ...
    fractional conversion_buffer[PLANALTA_25KHZ_F0_OUTPUT_SIZE];
    fractional sample_buffer[PLANALTA_25KHZ_F0_OUTPUT_SIZE];
...
void run_filter4_25khz(void){
    ...
    if(block_counter == PLANALTA_25KHZ_FX_INPUT_SIZE){
        block_counter = 0;
        start_filter5 = 1;
    }
}
...
void run_filter5_25khz(void){
    ...
    for(i = 0; i < PLANALTA_25KHZ_N_ADC_CHANNELS; i++){
        fir_compressed(PLANALTA_25KHZ_FX_OUTPUT_SIZE,
                &output_buffer_a_i[i],
