...
extern fractional fo1_buffer_i_write[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F2_INPUT_SIZE];
extern fractional fo1_buffer_q_write[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F2_INPUT_SIZE];
extern fractional fo2_buffer_i_write[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F3_INPUT_SIZE];
extern fractional fo2_buffer_q_write[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F3_INPUT_SIZE];
extern fractional f3_to_f4_buffer_i[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F4_INPUT_SIZE];
extern fractional f3_to_f4_buffer_q[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_F4_INPUT_SIZE];
extern fractional f4_to_fx_buffer_i[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_FX_INPUT_SIZE];
extern fractional f4_to_fx_buffer_q[PLANALTA_N_ADC_CHANNELS][PLANALTA_25KHZ_FX_INPUT_SIZE];
...
void adc_rx_callback_25khz(void){
    ...
    for(i = 0; i < PLANALTA_25KHZ_N_ADC_CHANNELS; i++){
        ...
        void process_filter_block0_25khz(void){
}
        ...
        lia_mixer_no_dc(PLANALTA_25KHZ_F0_OUTPUT_SIZE,
            conversion_buffer,
            sample_buffer,
            &sample_buffer[PLANALTA_25KHZ_F1_INPUT_SIZE]);
